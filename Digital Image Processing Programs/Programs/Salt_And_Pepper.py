'''Program to observe the effect of median filter
on an image corrupted by salt and pepper method.'''
...
noisy_img = cv2.imread('Salt_And_Pepper.jpg', 0)  # Read as grayscale
